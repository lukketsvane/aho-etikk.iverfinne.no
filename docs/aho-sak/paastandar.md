# Påstandar til verifisering

Strukturert uttrekk frå brevet til Killi og Notion-materialet. Kvar påstand skal
**verifiserast mot primærkjelde** før bruk. Status: 🔴 uverifisert · 🟡 delvis ·
🟢 verifisert. Styrke: Sterk/Medium/Svak (jf. [`../metodikk.md`](../metodikk.md)).
...
| A7 | Vurderinga skal vere tilpassa læringsutbytet (samsvar læringsutbyte↔vurdering) | 🟢 | **Kravet held — oppdatert heimel.** § 2-2 oppheva 1.8.2025, men konsolidert i **UH-forskrifta (FOR-2024-06-28-1392) § 1-11 c/e** (vilkår for akkreditering), stadfesta i vårt eige korpus. **Slutt å sitere «studietilsynsforskrifta § 2-2»; bruk § 1-11 c/e + NKR nivå 7** |
...
| A11 | AHO éin av berre 2 av 78 utan etisk eksternprosedyre | ⛔→🟢 | **«2 av 78» er FALSK** (47 koda: 25 manglar eksternprosedyre). Men **omformulert held det**: 13 skular — m.a. 7 av 11 norske (UiT, NTNU, NMBU, OsloMet, KHiO, Kristiania, UiS) — har ein eksternprosedyre AHO manglar; AHO blant svakaste i Noreg. Sjå [`etikk-benchmark.md`](etikk-benchmark.md) |
...
> ⚠️ Desse er bakgrunn/kontekst i brevet, ikkje AHO-funn. Dei er alvorlege og
> **må verifiserast mot uavhengige primærkjelder** før dei brukast. Repoet
> refererer dei; det stadfestar dei ikkje. Presseetikk gjeld.
...
| B3a | Palantir–Israel kontrakt (jan 2024) | 🟢 | Kontrakt/«strategisk partnarskap» med israelsk forsvarsdept. er fakta (selskapet stadfestar) |
| B3a | Palantir styrer Lavender/Gospel-måljakt i Gaza | 🔴 | **Avvist av Palantir; inga uavhengig stadfesting.** Ikkje framstill som fakta — streng attribusjon |
| B3b | Palantir–ICE «ImmigrationOS» (apr 2025; leverandør sidan 2013) | 🟢 | Dokumentert (Axios, kongressbrev). Skil «verktøy» frå «namngjevne razziaar» |
| B4 | Minab-åtak 28.02.2026 (skule, Tomahawk, sannsynleg US-ansvar) | 🟢 | **Hendinga er reell og breitt dokumentert** (Reuters/AP/BBC Verify/OHCHR/Amnesty/HRW) |
| B4 | Dødstal «160/150/148» + «fleirtal jenter» | 🟡 | **Feil å rette:** best dokumentert ~**156**, fleirtal *barn* (kjønn omstridd). «koda som militærbase» = utdatert feilklassifisering. **Ingen Palantir↔Minab-kopling** |
...
Brevversjonane sprikar i talet på drepne i Minab (148 / 150 / 160) og i kor
direkte Palantir-koplinga er formulert. Bruk det mest varsame, kjeldeførte talet,
og marker spriket eksplisitt.
