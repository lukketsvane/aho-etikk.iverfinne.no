...
Styrke: 🟢 Sterk (primærkjeldefesta, toler tilsvar) · 🟡 Medium (krev litt meir) ·
🔴 Svak/indikasjon (treng innsyn/verifisering).
...
| 6 | **Berkano AS: kommersialisering → KD trekte selskapsfullmakta** | Interessekonflikt | 🟢 | Riksrevisjonen Dok 1 (2004) | (historisk) |
| 7 | **Institusjonsavtale med Kongsberg Gruppen om sikkerheitskritisk design (2025), signert av rektor, møtt med demonstrasjon** | Interessekonflikt | 🟢 | Notion-funn (kjeldeført); krev kontraktinnsyn | Offentleg, KD, innsyn |
| 8 | **OICL: tett industri-/forsvarsnær finansiering; avtale med Kongsberg Maritime** | Interessekonflikt | 🟢 | Notion-funn; OICL-partnarar (Kongsberg, ABB, GE, DNV, Lloyd's) | Offentleg, innsyn |
| 9 | **Inga etisk vurdering (due diligence) av eksterne partnarar i nokon styresak** | Ansvarsglipe | 🟢 | Fulltekst 6 styre-saksframlegg | NOKUT, offentleg |
| 10 | **Ekstern evaluering: master i design utan forskingskurs** | Ansvarsglipe | 🟢 | Ekstern programevaluering (sak 32/23, 2023) | NOKUT |
| 11 | **Sektortopp på mellombels tilsetjing / vikarbruk; «lufting» av tilsette** | Styringssvikt | 🟢 | DBH; gjentatt KD-kritikk (2021, 2022) | Arbeidstilsynet, KD |
...
| 23 | Skulepengar for ikkje-EØS gav auka fråfall; ingen eigne stipend | Ansvarsglipe | 🟡 | AHO; DBH-fråfall |
| 24 | To varslingssaker (begge frå studentar); manglande rutinar | Ansvarsglipe | 🟡 | innsyn |
| 25 | Avlyste kritiske arrangement (Sverre Fehn-debatt 2024; AHO Works 2025) vs. «kritisk» sjølvbilde | Ansvarsglipe | 🟡 | offentleg omtale |
...
| Funn | Styrke | Merknad |
| --- | --- | --- |
| Alumnus Rune Breili dømd for grov korrupsjon (Tjøme-saka, 2023) | 🟢 | Enkeltperson, ikkje AHO. Berre relevant om AHO-rolla er reell |
| Aleksander Johansen: Økokrim-førelegg (Breili-saka, 2024) | 🟡 | Som over |
| Snøhetta (AHO-utdanna): oppdrag for Saudi Aramco | 🔴 | Selskap/alumni, ikkje AHO |
...
1. **Etikk-infrastrukturen manglar** (kjernen): #1, #2, #9, #10, #17, #20, #21 +
   benchmark (AHO blant svakaste norske). → **NOKUT/KD/offentleg.**
2. **Forsvars-/overvakingsteknologi** (mest konsekvensrik, mest sensitiv):
   #7, #8, #19 + Kongsberg/F-35/Israel-kontekst. → **innsyn + offentleg**, streng
   kjeldekritikk.
3. **Styring og økonomi** (lengst dokumentasjonsspor): #5, #6, #11. → **Riksrevisjonen.**
4. **Lovbrot** (konkrete, etterprøvbare): #3 (NOKUT), #4 (språklov), #18
   (Datatilsynet). → respektive tilsyn.
5. **Læringsmiljø/arbeidsmiljø**: #11, #12, #24, #25, #27. → **Arbeidstilsynet/offentleg.**
6. **Løftebrot (retorikk vs. praksis)**: #14, #15, #16, #22. → **offentleg/presse.**

## Eskaleringskart (instans → sterkaste funn)
