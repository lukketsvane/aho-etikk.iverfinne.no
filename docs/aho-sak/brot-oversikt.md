...
> **Bindande atterhald.** Dette er ein arbeidsmatrise over **funn som må
> verifiserast**, ikkje fastslått skuld. Før eskalering/publisering: gi AHO og
> namngjevne personar **samtidig imøtegåing** (Ver Varsam 4.14). Skil
> **institusjonen AHO** frå **enkeltpersonar/alumni** (sistnemnde er ikkje AHOs
> ansvar). Sensitive geopolitiske koplingar (Kongsberg/F-35/Israel, Palantir)
> krev streng, fleirkjelde-dokumentasjon og skal ikkje overdrivast.
...
| --- | --- | --- | --- | --- | --- |
| 1 | **Lovpålagt etikk-læringsutbyte vert aldri prøvd i vurdering** | Regelbrot | Sterk | NKR nivå 7 + UH-forskrifta § 1-11; AHO studieplan/emne | NOKUT, KD |
...
| --- | --- | --- | --- | --- |
| 14 | «Klimamessig berekraftig framtid» (marknad) vs. «viktig tematikk» i styrepapir | Løftebrot | Medium | aho.no vs. styrepapir |
| 15 | Utviklingsavtalen 2023-2026: bindande lovnad om berekraft, lite operasjonalisert | Løftebrot | Medium | regjeringen.no; styrevedtak |
| 16 | Strategien «Å forme fremtiden»/jubileum: lovnad om ansvar vs. avlyste debattar | Løftebrot | Medium | AHO strategi; avlyst Fehn-debatt, AHO Works |
...
| --- | --- | --- | --- | --- |
| 28 | Brevet: studentar lærer å be om innsyn i overvakingssystem, ikkje å seie nei | Ansvarsglipe | Svak | Tolking/retorikk - ikkje sjølvstendig bevis |
| 29 | Styreleiar med brei næringslivsportefølje (mogleg habilitet) | Interessekonflikt | Svak | Ope spor - kartlegg roller (Brreg) |
| 30 | Equinor/olje: inga stadfesta designkontrakt | Faktasjekk | Svak | Hol - ikkje dokumentert |
| 31 | Autoritære regime: ingen stadfesta AHO-avtale | Faktasjekk | Svak | Hol - gjeld alumni/Snøhetta, ikkje AHO |

## Alumni / eksterne (IKKJE AHO-institusjonen - handter varsamt)

| Funn | Styrke | Merknad |
| --- | --- | --- |
| Alumnus Rune Breili dømd for grov korrupsjon (Tjøme-saka, 2023) | Sterk | Enkeltperson, ikkje AHO. Berre relevant om AHO-rolla er reell |
| Aleksander Johansen: Økokrim-førelegg (Breili-saka, 2024) | Medium | Som over |
| Snøhetta (AHO-utdanna): oppdrag for Saudi Aramco | Svak | Selskap/alumni, ikkje AHO |

---

## Tematiske klynger (for ein eventuell sak)

1. **Etikk-infrastrukturen manglar** (kjernen): #1, #2, #9, #10, #17, #20, #21 +
 benchmark (AHO blant svakaste norske). til **NOKUT/KD/offentleg.**
2. **Forsvars-/overvakingsteknologi** (mest konsekvensrik, mest sensitiv):
 #7, #8, #19 + Kongsberg/F-35/Israel-kontekst. til **innsyn + offentleg**, streng
 kjeldekritikk.
3. **Styring og økonomi** (lengst dokumentasjonsspor): #5, #6, #11. til **Riksrevisjonen.**
4. **Lovbrot** (konkrete, etterprøvbare): #3 (NOKUT), #4 (språklov), #18
 (Datatilsynet). til respektive tilsyn.
5. **Læringsmiljø/arbeidsmiljø**: #11, #12, #24, #25, #27. til **Arbeidstilsynet/offentleg.**
6. **Løftebrot (retorikk vs. praksis)**: #14, #15, #16, #22. til **offentleg/presse.**

## Eskaleringskart (instans til sterkaste funn)

| Instans | Sterkaste funn å føre |
| --- | --- |
| **NOKUT** | #1, #3, #9, #10, #17 (etikk-utbyte ikkje prøvd; § 4-1; sjølvakkreditering) |
| **Kunnskapsdepartementet** | #2, #4, #11, #15 (forskingsetikk, språklov, mellombels, utviklingsavtale) |
| **Riksrevisjonen** | #5, #6, #11 (økonomi/styring over tid) |
| **Datatilsynet** | #18 (overvakingskamera/personvern) |
...
## Tillegg (lagt til etter samanslaainga)

| Brot / loftebrot | Tier | Kategori | Styrke | Kjelde | Eskalering |
| --- | --- | --- | --- | --- | --- |
| Kongsberg i F-35-kjeda til Israel: Stortinget-sporsmaal og nederlandsk domstol | 1 | Interessekonflikt | Sterk | Stortinget skriftlege sporsmaal; nederlandsk domstol (2024). Forsterkar Kongsberg-klynga (rad 7-8) | Offentleg/presse, Innsyn |
| Etikk/berekraft-retorikken er ny marknadsforing (2019+), ikkje institusjonelt forankra | 2 | Loftebrot | Medium | Wayback: fraaverande 2010/2014, dukka opp 2019, intensivert 2025; ikkje i Om AHO. data/harvest/wayback-aho-index.csv | Offentleg/presse |
| DBH: design-kull dobla (korona) og kutta att; 2-aarig master 0 mott 2024-2025 | 1 | Styringssvikt | Sterk | DBH/HK-dir instkode 1220: kull ca 30 (2017-19) til 59/59/60 (2020-22) til 31/40/35 (2023-25). KD-driven. data/harvest/dbh-aho-design-tidsserie.csv | KD |
